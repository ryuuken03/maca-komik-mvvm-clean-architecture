                    ...
                    if (data.popular != null) {
                        if(data.popular!!.size > 0){
                                            ...
                                            ThumbnailComic(
                                                ...
                                                onClick = fun(){
                                                    ...
                                                    if(thumbnail.imgSrc!=null){
                                                        image = URLEncoder.encode(thumbnail.imgSrc, "UTF-8")
                                                    }
                                                    var url = URLEncoder.encode(thumbnail.url!!, "UTF-8")
                            ...
                            item(span = { GridItemSpan(3) }){
                                ...
                                var sourceTitle =
                                    stringArrayResource(id =
                                    R.array.source_website_title)[index]
                                OutlinedButtonPrimary(
                                    ...
                                    onClick = {
                                        ...
                                        var pathEncode = URLEncoder.encode(projectPath,"UTF-8")
